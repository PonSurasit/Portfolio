  ...
  return (
    ...
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
        ...
        <div className="lg:flex xl:justify-center">
            <Link
            href="/"
            className="text-xl p-2 rounded-xl font-title text-gray-900 flex items-center justify-center bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500"
            >
                {/* <span className="text-white mr-1">Pon</span>
                <span className="w-12 h-8 rounded bg-white text-black flex items-center justify-center">.dev</span> */}
                <span className="md:text-2xl lg:text-3xl xl:text-4xl">Pon</span>
                <span className="md:text-2xl lg:text-3xl xl:text-4xl">.dev</span>
            </Link>
        </div>
        {/* LINKS */}
        ...
        {/* <div className="hidden md:flex gap-4 w-1/3">
            ...
            <Link href="/">
                <Image src="/line.png" alt="" width={27} height={27} />
            </Link>
        </div> */}
        {/* RESPONSIVE MENU */}
